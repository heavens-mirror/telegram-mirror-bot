...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://graph.org/file/2d63e68b8c4ef10928d20.png" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://graph.org/file/2d63e68b8c4ef10928d20.png"
          alt="logo"
        />
...
@app.route('/')
def homepage():
    return "<h1>Heavens Arena Mirror Group <a href='https://t.me/heavens_arena'>@GitHub</a> By <a href='https://github.com/rajput-hemant'>rajput-hemant</a></h1>"
